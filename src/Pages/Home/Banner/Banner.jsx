    ...
    return (
        <div className="carousel w-full h-[600px]">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute flex items-center h-full rounded-xl left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00) 100%)]">
            ...
            <div id="slide6" className="carousel-item relative w-full">
                <img src={img6}  className="w-full rounded-lg object-cover"/>
                <div className="absolute flex items-center h-full rounded-xl left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00) 100%)]">
                    <div className='w-1/2 text-white space-y-7 pl-12'>
                        <h2 className='text-6xl font-bold'>Affordable Price For Car Servicing</h2>
                        <p className=''>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
